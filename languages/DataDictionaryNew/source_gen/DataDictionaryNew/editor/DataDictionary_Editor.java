...
public class DataDictionary_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_r8s0uu_a1a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new DataDictionary_Editor.aggregationListListHandler_r8s0uu_a1a(node, "aggregationList", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_aggregationList");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }
  private static class aggregationListListHandler_r8s0uu_a1a extends RefNodeListHandler {
    public aggregationListListHandler_r8s0uu_a1a(SNode ownerNode, String childRole, EditorContext context) {
